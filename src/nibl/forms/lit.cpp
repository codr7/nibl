...
namespace nibl::forms {
  Lit::Imp::Imp(Pos pos, Type &type, any &&data): Form::Imp(pos), val(type, move(data)) {}
  ...
  Lit::Lit(Pos pos, Type &type, any &&data): Form(make_shared<const Imp>(pos, type, move(data))) {}
}
