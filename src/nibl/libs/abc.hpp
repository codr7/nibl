...
namespace nibl::libs {
  ...
  struct BoolType: Type {
    ...
    optional<Error> emit(VM &vm, Env &env, const Val &val) override;
  ...
  struct ABC: Lib {
    ...
    Macro add_macro, and_macro, div_macro, dup_macro, else_macro, eq_macro, func_macro, gt_macro, if_macro,
      lt_macro, mod_macro, mul_macro, not_macro, or_macro, pop_macro, stop_macro, sub_macro, swap_macro,
      test_macro, trace_macro, type_of_macro;
